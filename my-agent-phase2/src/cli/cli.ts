...
╔════════════════════════════════════════════╗
║     My Agent Phase 1 - Core Skeleton        ║
╚════════════════════════════════════════════╝
${colors.reset}
`)
}
...
${colors.dim}Usage:${colors.reset}
  ${colors.green}bun run src/cli.ts <message>${colors.reset}    Send a single message
  ${colors.green}bun run src/cli.ts${colors.reset}              Interactive mode

${colors.dim}Examples:${colors.reset}
  ${colors.yellow}bun run src/cli.ts "Hello, how are you?"${colors.reset}
  ${colors.yellow}bun run src/cli.ts "List files in current directory"${colors.reset}
`)
}
...
async function main() {
  ...
  console.log(`${colors.dim}Session: ${session.name}${colors.reset}\n`)
